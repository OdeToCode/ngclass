(function() { 
    ...
    module.config(function($routeProvider) {
        ...
        angular.forEach(routes, function(route) {
            route.settings.templateUrl = "/moviesapp/templates/" + route.settings.templateUrl;
    ...
    module.run(function($rootScope) {
        ...
        $rootScope.validationErrors = "/moviesApp/templates/validationErrors.html";
        $rootScope.toptemplate = "/moviesApp/templates/topdark.html";
