...
namespace AtTheMovies.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<AtTheMovies.Data.MovieDataContext>
    {
        ...
        protected override void Seed(MovieDataContext context)
        {
            ...
            defaultMovies.Add(new Movie { Title = "Star Wars", Length = 101, ReleaseDate = new DateTime(1977, 1, 1) });
            defaultMovies.Add(new Movie { Title = "Empire Strikes Back", Length = 120, ReleaseDate = new DateTime(1981, 6, 1) });
            defaultMovies.Add(new Movie { Title = "Return of the Jedi", Length = 99, ReleaseDate = new DateTime(1984, 11, 1) });
