(function() { 
    ...
    module.config(function($routeProvider) {
        ...
        angular.forEach(routes, function(route) {
            route.settings.templateUrl = "/apps/moviesapp/templates/" + route.settings.templateUrl;
    ...
    module.run(function($rootScope) {
        ...
        $rootScope.validationErrors = "/apps/moviesApp/templates/validationErrors.html";
        $rootScope.toptemplate = "/apps/moviesApp/templates/topdark.html";
